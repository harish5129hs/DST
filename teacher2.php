...
function my(){
	var A="<?php echo $r['designation'];?>";
	var B="<?php echo $r['department'];?>";
 
if(A!='Professor'&&A!='Assistant Professor'&&A!='Research Associate'){
	var element=document.getElementById("designation");
	...
	element.style.display="block"; 
            textdesi=1;
            des=1
}else if(A=='Professor'||A=='Assistant Professor'||A=='Research Associate'){
	des=1;
}

if(B!='cse'&&B!='ece'&&B!='civil'){
	var element=document.getElementById("dep");
         
	element.style.display="block"; 
            textdep=1;
            dep=1;
}else if(B=='cse'||B=='ece'||B=='civil'){
	dep=1;
}
...
<div id="options">
  ...
  <div class="container-fluid">
    ...
    ?>
      ...
      <div class="col-md-5 text-center"><br><br><h2 class="stroke"> Indian Origin Acadamicians Database</h2></div>
      <div class="col-md-3">
		...
		<div id="wrapper">
			...
			<div id="main">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10"><div class="well well-sm" align="center">Basic Information</div></div>
                        </div>
                        </div>
                     ...
                     <div id=inner>
                       ...
                       <div class="row">
						    ...
						    <div class="panel-body"><input type="text" name="firstname" placeholder="Type First Name" id="first" value="<?php echo $r['firstname']; ?>" required></div>
						    </div>

                            <div class="col-md-1"></div>
						    <div class="col-md-3">
						    <strong>&nbsp &nbsp Middle Name</strong>
						    <div class="panel-body"><input type="text"/ name="middlename" placeholder="Type Middle Name" id="middle" value="<?php echo $r['middlename']; ?>"></div>
						    </div>

                            <div class="col-md-1"></div>
						    <div class="col-md-3">
						    <strong>&nbsp &nbsp <span class="error">*</span>Last Name</strong>
						    <div class="panel-body"><input type="text"/ name="lastname" placeholder="Type Last Name" id="last" value="<?php echo $r['lastname']; ?>" required></div>
						    </div>
					   ...
					   <div class="row">
						    ...
						    <div class="panel-body"><input type="email" name="email" id="emailid" autocomplete="on"  placeholder="Type Email" onkeyup="validate_email(this.value);" value="<?php echo $r['email']; ?>"required></div>
						      <div id="sp"></div>
						    </div>
						    ...
						    <div class="panel-body"><input type="text" name="employer" value="<?php echo $r['employer']; ?>" placeholder="Type Current Employer" 
						    id="employer" required></div>
						    </div>
							...
							<select class="form-control" name="designation1" id="desi"  onchange="checkde(this.value);checkdesi();">
							  ...
							  <br />
 							  ...
 							  <input type="text" id="designation" name="designation2"  placeholder="Type Designation" value="<?php echo $r['designation']; ?>" onkeyup="displaydesi();" />
 							  <div id="des1"></div>
					   ...
					   <div class="row">
							...
							<select class="form-control" name="department1" id="department"  onchange="checkdp(this.value);checkdep();">
							  ...
							  <br />
 							  <input type="text" id="dep" name="department2"  placeholder="Type Department" value="<?php echo $r['department']; ?>"  onkeyup="displaydep();" />
 							  <div id="dep1"></div>
							</div>
                            </div>
